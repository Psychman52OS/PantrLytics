...
| Guide | Description |
|---|---|
| [Getting Started](ha/getting-started.md) | Install the add-on, configure options, first login |
...
| Guide | Description |
|---|---|
| [Getting Started](docker/getting-started.md) | Docker Compose install, .env config, first login |
...
| [FAQ](docker/faq.md) | Common questions and troubleshooting |
